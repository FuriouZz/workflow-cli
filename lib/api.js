...
module.exports = {
  ...
  taskProcess() {
    ...
    const action = function() {
      ...
      psExec.on('end', (err, stdout, stderr) => {
        if (callback) {
          callback.apply(this, [err, stdout, stderr])
...
module.exports.command = function() {
  console.log('command is deprecated. Prefer taskProcess')
  taskProcess.apply(null, arguments)
}