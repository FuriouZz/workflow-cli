...
class Task {
  ...
  _generatePromise() {
    ...
    this.promise.catch( _handleError )
  ...
  fail( value, directThrowError ) {
    ...
    directThrowError = typeof directThrowError === 'boolean' ? directThrowError : true
    if (directThrowError) _handleError( err )
  }
