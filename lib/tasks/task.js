...
class Task {
  ...
  constructor(name, options) {
    ...
    this._setOptions(options, {
      ...
      always_run: false,
      breakOnError: false,
      argv: wk.ARGV[this.path+'_argv'] || [],
      argvConfig: {}
    })

    this.argv = ARGParser.parse( this.argv, this.argvConfig )
  ...
  _execute() {
    ...
    if (this.canExecute()) {
      ...
      this.value = this.action.apply( this, this.argv.__._.slice(0).concat([this.argv]) )
